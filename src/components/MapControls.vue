<template>
	<div class="map-controls">
		...
		<div class="control-group">
			...
			<!-- Trees -->
			<v-tooltip v-if="view !== 'grid' && postalCode" location="left" max-width="200">
			...
			<v-tooltip v-if="helsinkiView" location="left" max-width="200">
				<template #activator="{ props }">
					<div v-bind="props" class="control-item">
						<v-switch
		...
		<!-- Building Filters -->
		<div v-if="view !== 'grid'" class="control-group">

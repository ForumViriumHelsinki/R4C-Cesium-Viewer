...
watch(() => loadingStore.hasActiveLoading, (isLoading) => {
...
.layer-progress:nth-child(1) { border-left-color: #4caf50; }
.layer-progress:nth-child(2) { border-left-color: #2196f3; }
.layer-progress:nth-child(3) { border-left-color: #ff9800; }
.layer-progress:nth-child(4) { border-left-color: #9c27b0; }

<template>
	...
	<div class="slider-container" style="width: 100%">
		...
		<div v-if="helsinkiView" class="switch-container">
			<label class="switch">
				<input v-model="showVegetation" type="checkbox" @change="loadVegetation" />
		...
		<div v-if="helsinkiView" class="switch-container">
			<label class="switch">
				<input v-model="showOtherNature" type="checkbox" @change="loadOtherNature" />
				<span class="slider round" />
			</label>
			<label for="showOtherNature" class="label">Other Nature</label>
		</div>

		<div v-if="view !== 'grid' && postalCode" class="switch-container">
			<label class="switch">
				<input v-model="showTrees" type="checkbox" @change="loadTrees" />
				<span class="slider round" />
			</label>
		...
		<div v-if="!helsinkiView" class="switch-container">
			<label class="switch">
				<input v-model="landCover" type="checkbox" @change="addLandCover" />
				<span class="slider round" />
			</label>
		...
		<div class="switch-container">
			<label class="switch">
				<input v-model="ndvi" type="checkbox" @change="toggleNDVI" />
				<span class="slider round" />
			</label>
			<label for="ndvi" class="label">NDVI</label>
		</div>
	</div>
</template>

<template>
	...
	<div class="slider-container" style="width: 100%">
		...
		<div class="switch-container">
			<label class="switch">
				<input v-model="hideNonSote" type="checkbox" @change="filterBuildings" />
				<span class="slider round" />
			</label>
			<label v-if="!helsinkiView" for="hideNonSote" class="label">Only public buildings</label>
			<label v-if="helsinkiView" for="hideNonSote" class="label"
				>Only social & <br />
		...
		<div v-if="helsinkiView" class="switch-container">
			<label class="switch">
				<input v-model="hideNewBuildings" type="checkbox" @change="filterBuildings" />
				<span class="slider round" />
			</label>
		...
		<div class="switch-container">
			<label class="switch">
				<input v-model="hideLow" type="checkbox" @change="filterBuildings" />
				<span class="slider round" />
			</label>

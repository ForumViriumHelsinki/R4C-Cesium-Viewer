	...
	state: () => ({
		...
		flags: {
			...
			ndvi: {
				...
				description: 'Normalized Difference Vegetation Index visualization for vegetation health analysis',
			...
			sentryErrorTracking: {
				enabled: import.meta.env.VITE_SENTRY_DSN !== undefined && import.meta.env.VITE_SENTRY_DSN !== '',
			...
			digitransitIntegration: {
				enabled: import.meta.env.VITE_DIGITRANSIT_KEY !== undefined && import.meta.env.VITE_DIGITRANSIT_KEY !== '',

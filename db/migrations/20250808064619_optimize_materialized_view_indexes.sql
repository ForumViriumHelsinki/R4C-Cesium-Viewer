...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_kayttarks
ON public.r4c_hsy_building_mat (kayttarks);

-- Index for building size filtering
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_area_m2
ON public.r4c_hsy_building_mat (area_m2);

-- Index for construction year
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_kavu
ON public.r4c_hsy_building_mat (kavu);

-- Composite index for common query patterns
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_composite
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_postalcode_mat_avgheatexposure
ON public.r4c_postalcode_mat (avgheatexposure);

-- Add index for cold exposure filtering
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_postalcode_mat_avgcoldexposure
ON public.r4c_postalcode_mat (avgcoldexposure);

-- Add index for helsinki urban heat data
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_postalcode_mat_hki_avgheatexposure
ON public.r4c_postalcode_mat (hki_avgheatexposure);

-- Composite index for heat analysis queries
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_postalcode_mat_heat_composite
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_heat_timeseries_notnull
ON public.r4c_hsy_building_mat (vtj_prt)
WHERE heat_timeseries IS NOT NULL AND heat_timeseries != '[]';

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_postalcode_mat_cold_notnull
ON public.r4c_postalcode_mat (postinumero)
WHERE avgcoldexposure IS NOT NULL;

-- Functional indexes for common calculated fields
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_floor_area_ratio
ON public.r4c_hsy_building_mat ((kerala / NULLIF(area_m2, 0)));

-- GiST index for bounding box queries on materialized views
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_hsy_building_mat_geom_box
ON public.r4c_hsy_building_mat USING gist (ST_Envelope(geom));

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_r4c_postalcode_mat_geom_box
...
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_postalcode_mat_geom_box;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_geom_box;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_floor_area_ratio;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_postalcode_mat_cold_notnull;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_heat_timeseries_notnull;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_postalcode_mat_heat_composite;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_postalcode_mat_hki_avgheatexposure;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_postalcode_mat_avgcoldexposure;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_postalcode_mat_avgheatexposure;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_composite;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_kavu;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_area_m2;
DROP INDEX CONCURRENTLY IF EXISTS public.idx_r4c_hsy_building_mat_kayttarks;

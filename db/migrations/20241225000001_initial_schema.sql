...
DROP TABLE IF EXISTS public.vegetation_r4c CASCADE;
DROP TABLE IF EXISTS public.urbanheattest CASCADE;
DROP TABLE IF EXISTS public.urban_heat_building_f CASCADE;
DROP TABLE IF EXISTS public.urban_heat_building CASCADE;
DROP TABLE IF EXISTS public.tree_f_test CASCADE;
DROP TABLE IF EXISTS public.tree_f CASCADE;
DROP TABLE IF EXISTS public.tree_distance_building CASCADE;
DROP TABLE IF EXISTS public.tree_building_distance CASCADE;
DROP TABLE IF EXISTS public.schema_migrations CASCADE;
DROP TABLE IF EXISTS public.r4c_users CASCADE;
DROP TABLE IF EXISTS public.r4c_paavo CASCADE;
DROP TABLE IF EXISTS public.r4c_hsy_building_copy CASCADE;
DROP TABLE IF EXISTS public.r4c_hsy_building_backup CASCADE;
DROP TABLE IF EXISTS public.r4c_hsy_building_current CASCADE;
DROP TABLE IF EXISTS public.r4c_heat_timeseries CASCADE;
DROP TABLE IF EXISTS public.r4c_coldspot CASCADE;
DROP TABLE IF EXISTS public.other_nature_r4c CASCADE;
DROP TABLE IF EXISTS public.nature_area_f CASCADE;
DROP TABLE IF EXISTS public.nature_area CASCADE;
DROP TABLE IF EXISTS public.keharist_data CASCADE;
DROP TABLE IF EXISTS public.keharist_catalogue CASCADE;
DROP TABLE IF EXISTS public.kafka_finest_station CASCADE;
DROP TABLE IF EXISTS public.hsy_building_heat CASCADE;
DROP TABLE IF EXISTS public.hki_urbanheat CASCADE;
DROP TABLE IF EXISTS public.hki_travel_time_r4c_f CASCADE;
DROP TABLE IF EXISTS public.hki_roof_colors CASCADE;
DROP TABLE IF EXISTS public.heat_vulnerable_demographic CASCADE;
DROP TABLE IF EXISTS public.flood_f CASCADE;
DROP TABLE IF EXISTS public.flood CASCADE;
DROP TABLE IF EXISTS public.building_tree_undone CASCADE;
DROP TABLE IF EXISTS public.building_tree_for_bearing CASCADE;
DROP TABLE IF EXISTS public.building_tree CASCADE;
DROP TABLE IF EXISTS public.adaptation_landcover CASCADE;

-- Drop sequences
DROP SEQUENCE IF EXISTS public.vegetation_r4c_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.urbanheattest_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.urban_heat_building_f_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.urban_heat_building_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.tree_f_test_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.tree_f_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.tree_distance_building_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.tree_building_distance_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.schema_migrations_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_users_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_paavo_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_hsy_building_copy_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_hsy_building_backup_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_hsy_building_current_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_heat_timeseries_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.r4c_coldspot_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.other_nature_r4c_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.nature_area_f_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.nature_area_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.keharist_data_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.keharist_catalogue_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.kafka_finest_station_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.hsy_building_heat_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.hki_urbanheat_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.hki_travel_time_r4c_f_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.hki_roof_colors_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.heat_vulnerable_demographic_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.flood_f_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.flood_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.building_tree_undone_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.building_tree_for_bearing_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.building_tree_id_seq CASCADE;
DROP SEQUENCE IF EXISTS public.adaptation_landcover_id_seq CASCADE;

-- Drop functions
DROP FUNCTION IF EXISTS public.update_updated_at_column() CASCADE;

-- Extensions and schemas (uncomment if needed)

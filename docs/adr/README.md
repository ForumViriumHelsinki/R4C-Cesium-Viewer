...
This directory contains Architecture Decision Records for the R4C-Cesium-Viewer project.
...
| [ADR-008](./ADR-008-legacy-version-gateway-routing.md) | Legacy v1.22.x via Envoy Gateway Routing | Proposed | 2026-06-10 |

...
describe('address service', () => {
  describe('findAddressForBuilding', () => {
    ...
    it('should skip invalid oski1 values (999999999)', () => {
      ...
      expect(findAddressForBuilding(properties)).toBe('Helsingin tuomiokirkko 1');
    });
  ...
  describe('edge cases and error handling', () => {
    ...
    it('should handle special characters in addresses', () => {
      ...
      expect(findAddressForBuilding(properties)).toBe('Hämeentie/Tavastvägen 123-125');
    });
    ...
    it('should handle objects as properties', () => {
      ...
      expect(findAddressForBuilding(properties)).toBe('[object Object] [object Object]');
    });
  });
});
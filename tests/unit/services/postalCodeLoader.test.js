...
describe('postalCodeLoader service', () => {
	...
	describe('startCameraAnimation()', () => {
		...
		it('should resolve after 3 seconds', async () => {
			...
			expect(consoleLogSpy).toHaveBeenCalledWith('[PostalCodeLoader] ✓ Camera animation completed');
		});
	...
	describe('updateLoadingProgress()', () => {
		...
		it('should calculate correct percentages', () => {
			...
			expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('(75%)'));

  ...
  describe("getters", () => {
    ...
    describe("flagsByCategory", () => {
      it("should filter flags by category correctly", () => {
        ...
        expect(
          dataLayerFlags.every((flag) => flag.category === "data-layers"),
        ).toBe(true);
      });
  ...
  describe("actions", () => {
    describe("setFlag", () => {
      it("should set user override and persist to localStorage", () => {
        ...
        expect(localStorage.getItem("featureFlags")).toBe(
          JSON.stringify({ ndvi: false }),
        );
      });
    ...
    describe("loadOverrides", () => {
      it("should load overrides from localStorage", () => {
        localStorage.setItem(
          "featureFlags",
          JSON.stringify({ ndvi: false, heatHistogram: false }),
        );
    ...
    describe("exportConfig", () => {
      it("should create valid JSON with all flags", () => {
        ...
        expect(Object.keys(config).length).toBe(
          Object.keys(store.flags).length,
        );
      });

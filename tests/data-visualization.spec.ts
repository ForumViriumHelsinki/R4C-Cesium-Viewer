...
test.describe('Data Visualization Components', () => {
  ...
  test('should display charts and visualization components', async ({ page }) => {
    ...
    const chartContainers = page.locator('[id*="chart"], [id*="plot"], .chart-container, .plot-container');
  ...
  test('should display building information charts', async ({ page }) => {
    ...
    const buildingCharts = page.locator('#buildingGridChartContainer, [data-testid="building-chart"]');
  ...
  test('should display scatter plot visualizations', async ({ page }) => {
    ...
    const scatterPlots = page.locator('[class*="scatter"], [id*="scatter"], [data-testid*="scatter"]');

...
cesiumDescribe("View Modes Accessibility", () => {
  ...
  cesiumTest.describe("Capital Region View (Default)", () => {
    cesiumTest(
      "should load Capital Region Heat view by default",
      async ({ cesiumPage }) => {
        // Verify default view selection
        const capitalRegionRadio = cesiumPage.locator(
          'input[value="capitalRegionView"]',
        );
  ...
  cesiumTest.describe("Statistical Grid View", () => {
    cesiumTest(
      "should switch to Statistical Grid view successfully",
      async ({ cesiumPage }) => {
    ...
    cesiumTest(
      "should display grid-specific features when switched",
      async ({ cesiumPage }) => {
        await helpers.navigateToView("gridView");
    ...
    cesiumTest(
      "should enable 250m grid toggle in grid view",
      async ({ cesiumPage }) => {
        await helpers.navigateToView("gridView");
        await cesiumPage.waitForTimeout(2000);
  ...
  cesiumTest.describe("View Mode Transitions", () => {
    cesiumTest(
      ...
      async ({ cesiumPage }) => {
        ...
        let capitalRegionRadio = cesiumPage.locator(
          'input[value="capitalRegionView"]',
        );
        await expect(capitalRegionRadio).toBeChecked();
  ...
  cesiumTest.describe("View Mode Navigation Controls", () => {
    ...
    cesiumTest(
      "should preserve view mode when using reset button",
      async ({ cesiumPage }) => {
        // Switch to grid view
        await helpers.navigateToView("gridView");
        await expect(
  ...
  cesiumTest.describe("View Mode Data Loading", () => {
    cesiumTest(
      "should handle view switches during data loading states",
      async ({ cesiumPage }) => {
  ...
  cesiumTest.describe("Accessibility Compliance", () => {
    cesiumTest(
      "should have proper ARIA labels and keyboard navigation",
      async ({ cesiumPage }) => {
        ...
        const anyChecked =
          (await gridRadio.isChecked()) ||
          (await capitalRegionRadio.isChecked());

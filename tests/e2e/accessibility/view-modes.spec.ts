...
cesiumDescribe('View Modes Accessibility', () => {
  ...
  cesiumTest.describe('Capital Region View (Default)', () => {
    ...
    cesiumTest('should display appropriate panels for Capital Region view', async ({ cesiumPage }) => {
    ...
    cesiumTest('should maintain Capital Region view selection after page interactions', async ({ cesiumPage }) => {
  ...
  cesiumTest.describe('Statistical Grid View', () => {
    ...
    cesiumTest('should show cooling centers panel when heat index is selected', async ({ cesiumPage }) => {
      await helpers.navigateToView('gridView');
  ...
  cesiumTest.describe('View Mode Transitions', () => {
    cesiumTest('should transition from Capital Region to Statistical Grid smoothly', async ({ cesiumPage }) => {
    ...
    cesiumTest('should transition from Statistical Grid back to Capital Region', async ({ cesiumPage }) => {
  ...
  cesiumTest.describe('Helsinki Heat View (Conditional)', () => {
    cesiumTest('should conditionally show Helsinki Heat option based on postal code', async ({ cesiumPage }) => {
  ...
  cesiumTest.describe('View Mode Navigation Controls', () => {
    cesiumTest('should maintain view mode selection during navigation interactions', async ({ cesiumPage }) => {
      // Switch to grid view
      await helpers.navigateToView('gridView');
  ...
  cesiumTest.describe('View Mode Responsiveness', () => {
    cesiumTest('should maintain view mode functionality across different viewports', async ({ cesiumPage }) => {
      const viewports = [

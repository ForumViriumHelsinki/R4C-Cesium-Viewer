 ...
 */
const cesiumDescribeImpl = (title: string, fn: () => void) => {
...
/**
 * Skip a cesiumDescribe block entirely
 */
cesiumDescribeImpl.skip = (title: string, fn: () => void) => {
	cesiumTest.describe.skip(title, fn)
}
